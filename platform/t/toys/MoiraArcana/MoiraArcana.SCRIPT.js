...
// div collector
  ...
  const CardDraw = document.getElementById("CardDraw");
  const AppLogo = document.getElementById("AppLogo")

// base app settings
const GameTitle = "Moira Arcana"

// opening ROM launcher
GameScreen.innerHTML = "<h1 id='title'>" + GameTitle + "</h1><div>FORTUNE TELLER</div><div><button onclick='LoadROM()'>Load ROM</button>";
...
function LoadROM(){
  ...
  GameScreen.innerHTML = "<div id='AppLogo'></div>";
  

  AppLogo.innerHTML = "";
  AppControls.innerHTML = "<h1 id='IntroTitle'>" + GameTitle + "</h1>";
  AppControls.innerHTML += "<button class='gameBtn'>Load Deck</button>";
...
function Draw1(){
  ...
  barbFeedback = drawOne.barb[Math.floor(Math.random() * drawOne.barb.length)]

  Your1CardReading = drawStyle + " \n-" + drawOne.cardnumber + "-\n" + drawOne.cardname + "\n\n" + drawOne.cardmeaning + "\n\nBAR-B SAYS: " + barbFeedback;
